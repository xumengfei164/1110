            ...
            <div class="user-nav">
                <ul>
                   ...
                   <li class="profile-photo">
                        <img src="/bbs/Public/../Public/Uploads/2019-07-18/5d2ff1235e288.jpg" alt="" class="img-circle">
                    </li>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" action="update.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="radio" name="sex" value="m" <?php if($data['sex']) echo 'checked';?> >男　 
                                            <input type="radio"  name="sex" value="w" <?php if(!$data['sex']) echo 'checked';?> >女
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="tel" class="form-control" value="<?php echo $data['tel']?>">
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-3 control-label">头像</label>
                                            ...
                                            <img style='float:left;width:55px;height:54px;' src='.<?php echo $data['pic'] ?>'>
                                     

                                        <div class="col-sm-6">
                                            <input type="file" style="width:540px;" name="pic" class="form-control">
                                        </div>
                                    </div>
                                    <a href="./show.php" class="btn btn-primary" style="position:relative;left:35%;">返回</a>
                                     <button type="submit" class="btn btn-primary" style="position:relative;left:40%;">修改</button>
                                </form>
